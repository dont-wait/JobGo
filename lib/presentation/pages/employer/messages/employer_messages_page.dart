...
class _EmployerMessagesPageState extends State<EmployerMessagesPage> {
  ...
  final List<Map<String, dynamic>> _dummyMessages = [
    {
      'name': 'Nguyễn Văn A',
      'lastMessage': 'Cảm ơn công ty đã phản hồi. Hẹn gặp anh/chị tại buổi phỏng vấn.',
      'time': '09:30 AM',
      'isRead': false,
    },
    {
      'name': 'Trần Thị B',
      'lastMessage': 'Dạ, tôi sẽ bổ sung thêm portfolio vào hồ sơ ngay ạ.',
      'time': 'Hôm qua',
      'isRead': true,
    },
    {
      'name': 'Lê Hoàng C',
      'lastMessage': 'Chào nhà tuyển dụng, không biết vị trí này còn tuyển không ạ?',
      'time': '2 ngày trước',
      'isRead': true,
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Tin nhắn ứng viên'),
          centerTitle: true,
          actions: [
            IconButton(
